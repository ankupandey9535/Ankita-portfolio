...
export const AboutSection: React.FC = () => {
  return (
    <section id="about" className="relative min-h-screen w-full flex flex-col items-center justify-center bg-[#0C0C0C] px-5 sm:px-8 md:px-10 py-20 overflow-hidden">
      ...
      <div className="relative z-20 flex flex-col items-center text-center max-w-4xl w-full">
        ...
        <div className="mb-16 sm:mb-20 md:mb-24 px-4">
          <AnimatedText
            ...
            className="text-[#D7E2EA] font-medium leading-relaxed max-w-[560px] text-[clamp(1rem,2vw,1.35rem)] mx-auto"
          />
        </div>
